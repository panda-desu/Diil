  ...
  return (
    <div className="lg:pt-20 lg:ps-20 md:px-20 md:pt-20 pt-8 px-4 lg:block md:flex items-center justify-center">
      <div className="lg:w-[500px] md:w-[584px]">
        <p className="text-[#020618] font-bold text-[24px]">Санал хүсэлт</p>
        <p className="text-[#62748E] text-sm">
          Та бидэнд талархасан, тулгамдсан асуудал мөн сайжруулах хүсэлтэй зүйлс
          байвал нээлттэй явуулж болно шүү.
        </p>
        <div className="mt-12">
          <div className="flex flex-col md:flex-row items-center justify-between space-y-2.5 md:space-y-0">
            <button
              ...
              className={`md:px-[68px] lg:px-[47px] py-2 rounded-[999px] border text-[#020618] w-full md:w-auto transition-all duration-300 ${
                type === "collaboration"
                  ? "border-[#020618]"
                  : "border-[#CAD5E2]"
              }`}
            ...
            <button
              ...
              className={`md:px-[91px] lg:px-[70px] py-2 rounded-[999px] border text-[#020618] w-full md:w-auto transition-all duration-300 ${
          ...
          <div className="my-4 space-y-4">
            <input
              ...
              placeholder="Санал хүсэлтийн агуулга"
              type="text"
            />
            <input
              className="w-full bg-[#F1F5F9] rounded-[16px] px-4 py-2 text-[#45556C]"
